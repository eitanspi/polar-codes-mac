#!/usr/bin/env python3
"""
train_n256_long_cpp.py — Long N=256 training using C++ tree walk forward.

Same as train_n256_long.py but uses the C++ extension for ~1.3x speedup.
"""
...
def evaluate(model, channel, b, Au, Av, fu, fv, n_cw):
    """Eval uses Python forward (simpler, no weight extraction needed)."""
    model.eval()
